...
contract ChatApp{
    ...
    function addFriend(address friend_key, string calldata name) external{
        ...
        require(msg.sender!=friend_key,"User cannot add themeselves as friends");
    ...
    //checkAlreadyFriends
    function checkAlreadyFriends(address pubkey1, address pubkey2) internal view
    returns (bool){
    ...
    function sendMessage(address friend_key, string calldata _msg) external{
        require(checkUserExists(msg.sender),"Create an account first");
        require(checkUserExists(friend_key),"User is not registered");
        require(checkAlreadyFriends(msg.sender, friend_key),"You are friend with the given user");
